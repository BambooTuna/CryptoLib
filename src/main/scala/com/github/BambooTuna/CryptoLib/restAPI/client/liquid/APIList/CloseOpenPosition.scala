...
class CloseOpenPosition(val apiKey: ApiKey, implicit val httpRequestElement: HttpRequestElement) extends LiquidRestAPI[EmptyEntityRequestJson, CloseOpenPositionQueryParameters, CloseOpenPositionResponse]
